...
*/
async function loginYucata() {
    const [browser, page, pagetext] = await utils_1.loginPuppeteer("https://www.yucata.de/en", process.env.USER, process.env.PASSWORD, '#ctl00_ctl07_edtLogin', '#ctl00_ctl07_edtPassword', '#ctl00_ctl07_btnLogin');
